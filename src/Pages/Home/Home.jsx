    ...
    <>
      ...
      <div className="it-category-title-wrap p-relative mt-5">
        <div className="it-category-shape d-none d-xl-block">
          <img src="https://ordainit.com/html/educate/assets/img/category/shape-1.png" alt="" width="140px" height="50px" />
        </div>
    ...
    {services.map((service) => (
      ...
      <div className="it-about-area p-relative pt-185 pb-185">
        <div className="it-about-shape-4 d-none d-md-block">
          <img src="https://ordainit.com/html/educate/assets/img/about/shape-1-4.png" alt="" width="40px" height="40px" />
        </div>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="it-about-thumb-box p-relative">
                <div className="it-about-thumb-1 d-none d-xl-block">
                  <img src="https://ordainit.com/html/educate/assets/img/about/thumb-1.jpg" alt="" width="170px" height="270px" />
                </div>
                <div className="it-about-thumb-2 d-none d-xl-block">
                  <img src="https://ordainit.com/html/educate/assets/img/about/thumb-2.jpg" alt="" width="170px" height="270px" />
                </div>
                <div className="it-about-main-thumb text-xl-end text-center">
                  <img src="https://ordainit.com/html/educate/assets/img/about/thumb-3.jpg" alt="" height="500px" />
                </div>
                <div className="it-about-shape-1 d-none d-md-block">
                  <img src="https://ordainit.com/html/educate/assets/img/about/shape-1-1.png" alt="" width="120px" height="120px" />
                </div>
                <div className="it-about-shape-2 d-none d-md-block">
                  <img src="https://ordainit.com/html/educate/assets/img/about/shape-1-2.png" alt="" width="65px" height="20px" />
                </div>
                <div className="it-about-shape-3 d-none d-md-block">
                  <img src="https://ordainit.com/html/educate/assets/img/about/shape-1-3.png" alt="" width="200px" height="200px" />
                </div>
              </div>
            </div>
                ...
                <div className="it-about-title-box mb-20">
                  ...
                  <h4 className="it-section-title">
                    ...
                    <span className="p-relative z-index skills-highlight">
                      skills
                      <svg className="title-shape-2" width="198" height="90" viewBox="0 0 220 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M73.3761 8.49147C78.4841 6.01353 82.5722 4.25154 88.8933 3.3035C94.2064 2.50664 99.6305 2.0701 104.981 1.94026C120.426 1.56549 135.132 4.90121 146.506 9.70405C158.628 14.8228 166.725 22.5638 166.074 31.6501C165.291 42.5779 151.346 51.7039 133.508 56.8189C110.253 63.4874 81.7065 63.8025 58.5605 60.8285C37.5033 58.123 11.6304 51.7165 3.58132 40.0216C-3.43085 29.8337 12.0728 18.1578 27.544 11.645C40.3656 6.24763 55.7082 2.98328 70.8043 4.08403C81.9391 4.89596 93.2164 6.87822 102.462 9.99561C112.874 13.5066 120.141 18.5932 127.862 23.6332" stroke="#0AB99D" strokeWidth="3" strokeLinecap="round" />
                      </svg>
                    </span>
                    <br />
      ...
      {/* =================== Video Section =================== */}
      <div className="it-video-area it-video-bg p-relative fix pt-100 pb-95" style={{backgroundImage: "url('https://ordainit.com/html/educate/assets/img/video/bg-1-1.jpg')"}}>
        <div className="it-video-shape-1 d-none d-lg-block">
          <img src="https://ordainit.com/html/educate/assets/img/video/shape-1-1.png" alt="" width="220px" height="120px" />
        </div>
        <div className="it-video-shape-2 d-none d-lg-block">
          <img src="https://ordainit.com/html/educate/assets/img/video/shape-1-2.png" alt="" width="200px" height="140px" />
        </div>
        <div className="it-video-shape-3 d-none d-lg-block">
          <img src="https://ordainit.com/html/educate/assets/img/video/shape-1-3.png" alt="" width="25px" height="25px" />
        </div>
        <div className="it-video-shape-4 d-none d-lg-block">
          <img src="https://ordainit.com/html/educate/assets/img/video/shape-1-4.png" alt="" width="30px" height="30px" />
        </div>
        <div className="it-video-shape-5 d-none d-lg-block">
          <img src="https://ordainit.com/html/educate/assets/img/video/shape-1-5.png" alt="" width="55px" height="20px" />
        </div>
            ...
            <div className="col-xl-5 col-lg-5 col-md-3 col-sm-3">
              <div className="it-video-play-wrap d-flex justify-content-start justify-content-md-end align-items-center">
                <div className="it-video-play text-center">
                  <a className="popup-video play" href="https://www.youtube.com/watch?v=PO_fBTkoznc">
                    <i className="fas fa-play"></i>
                  </a>
                  <a className="text" href="#">watch now</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="it-choose-area p-relative pt-180 pb-110">
        <div className="it-choose-shape-4 d-none d-md-block">
          <img src="https://ordainit.com/html/educate/assets/img/choose/shape-1-4.png" alt="" />
        </div>
              ...
              <div className="it-choose-left">
                ...
                <div className="it-choose-content-box">
                  <div className="row gx-20">
                    {["World Class Trainers", "Easy Learning", "Flexible", "Affordable Price"].map((item, index) => (
            ...
            <div className="col-xl-6 col-lg-6 mb-30">
              <div className="it-choose-thumb-box text-center text-md-end">
                <div className="it-choose-thumb p-relative">
                  <img src="https://ordainit.com/html/educate/assets/img/choose/choose-2-1.jpg" alt="" className="main-choose-img" />
                  <div className="it-choose-shape-1">
                    <img src="https://ordainit.com/html/educate/assets/img/choose/shape-1-1.png" alt="" width="220" height="220" />
                  </div>
                  <div className="it-choose-shape-2">
                    <img src="https://ordainit.com/html/educate/assets/img/choose/shape-1-2.png" alt="" width="220" height="220" />
                  </div>
                  <div className="it-choose-shape-3 d-none d-lg-block">
                    <img src="https://ordainit.com/html/educate/assets/img/choose/shape-1-3.png" alt="" width="200" height="200" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="it-team-area p-relative pt-120 pb-120">
        <div className="it-team-shape-1 d-none d-xl-block">
          <img src="https://ordainit.com/html/educate/assets/img/team/shape-1-1.png" alt="" />
        </div>
        <div className="it-team-shape-3 d-none d-xl-block">
          <img src="https://ordainit.com/html/educate/assets/img/team/shape-1-3.png" alt="" />
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-7 col-lg-7">
              <div className="it-team-right-box">
                <div className="row">
                  {[
                    {img: "https://ordainit.com/html/educate/assets/img/team/team-1-1.png", name: "Esther Howard", role: "Junior Instructor"},
                    {img: "https://ordainit.com/html/educate/assets/img/team/team-1-2.png", name: "Beverly Hathcock", role: "Junior Instructor"},
                    {img: "https://ordainit.com/html/educate/assets/img/team/team-1-3.png", name: "Donald Gonzales", role: "Junior Instructor"},
                    {img: "https://ordainit.com/html/educate/assets/img/team/team-1-4.png", name: "Eddie Lenz", role: "Junior Instructor"}
                  ].map((t, i) => (
      ...
      <div className="it-career-area it-career-bg p-relative pt-120">
        <div className="it-career-shape-2 d-none d-xl-block position-absolute">
          <img src="https://ordainit.com/html/educate/assets/img/career/shape-1-1.png" alt="" style={{width: "220px", height: "120px"}} />
        </div>
        <div className="it-career-shape-3 d-none d-xl-block position-absolute">
          <img src="https://ordainit.com/html/educate/assets/img/career/shape-1-2.png" alt="" style={{width: "40px", height: "40px"}} />
        </div>
        <div className="it-career-shape-4 d-none d-xl-block position-absolute">
          <img src="https://ordainit.com/html/educate/assets/img/career/shape-1-3.png" alt="" style={{width: "60px", height: "20px"}} />
        </div>
        <div className="it-career-shape-6 d-none d-xl-block position-absolute">
          <img src="https://ordainit.com/html/educate/assets/img/career/shape-1-5.png" alt="" style={{width: "60px", height: "60px"}} />
        </div>
          ...
          <div className="row">
            <div className="col-12 text-center mb-70">
              ...
              <h4 className="it-section-title">
                ...
                <span className="p-relative z-index">
                  Gain
                  <svg className="title-shape-2" width="168" height="65" viewBox="0 0 240 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M73.3761 8.49147C78.4841 6.01353 82.5722 4.25154 88.8933 3.3035C94.2064 2.50664 99.6305 2.0701 104.981 1.94026C120.426 1.56549 135.132 4.90121 146.506 9.70405C158.628 14.8228 166.725 22.5638 166.074 31.6501C165.291 42.5779 151.346 51.7039 133.508 56.8189C110.253 63.4874 81.7065 63.8025 58.5605 60.8285C37.5033 58.123 11.6304 51.7165 3.58132 40.0216C-3.43085 29.8337 12.0728 18.1578 27.544 11.645C40.3656 6.24763 55.7082 2.98328 70.8043 4.08403C81.9391 4.89596 93.2164 6.87822 102.462 9.99561C112.874 13.5066 120.141 18.5932 127.862 23.6332" stroke="#0AB99D" strokeWidth="3" strokeLinecap="round" />
                  </svg>
                </span>
              </h4>
            ...
            <div className="col-md-6 mb-30">
              <div className="it-career-item p-relative fix">
                <div className="it-career-content">
                  ...
                  <p>Join our training courses & <br /> Build your skill.</p>
                  <Button>Join now →</Button>
                </div>
                <div className="it-career-thumb">
                  <img src="https://ordainit.com/html/educate/assets/img/career/thumb-1.png" alt="thumb1" />
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 mb-5">
              <div className="it-career-item p-relative fix">
                ...
                <div className="it-career-thumb">
                  <img src="https://ordainit.com/html/educate/assets/img/career/thumb-2.png" alt="thumb2" />
                </div>
              </div>
            </div>
          </div>
...
<div className="it-category-title-wrap p-relative mt-5">
  ...
  <BlogCard />
  <BlogCard imgSrc={"https://ordainit.com/html/educate/assets/img/blog/blog-1-2.jpg"} />
  <BlogCard imgSrc={"https://ordainit.com/html/educate/assets/img/blog/blog-1-3.jpg"} />
