    ...
    <>
      <div className="card border-0 p-0 mb-5 overflow-hidden">
        {!galry ? (
          ...
          <>
            <button
              className="btn blog-arrow-left btn-light fw-bold text-white align-self-center"
              onClick={goLeft}
            >
              <FaArrowLeft />{" "}
            </button>
            ...
            <button
              className="btn btn-light blog-arrow-right fw-bold text-white align-self-center"
              onClick={goRigth}
            >
              <FaArrowRight />
            </button>
            ...
            <div ref={boxRef} className="card-img-top galry-style d-flex w-100">
              ...
              <img
                src="https://ordainit.com/html/educate/assets/img/blog/blog-sidebar-2.jpg"
                className="w-100"
                alt="Blog Post"
              />
              <img src={imgUrl} className="w-100" alt="Blog Post" />
