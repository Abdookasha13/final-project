...
const HeroSection = () => {
  return (
    <div
      ...
      style={{ backgroundImage: `url("https://ordainit.com/html/educate/assets/img/hero/hero-bg-1.jpg")` }}
    >
      <div className="it-hero-2-shape-4">
        <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-7.png" alt="" style={{ width: "350px", height: "200px" }} />
      </div>

      <div className="it-hero-2-shape-5 d-xl-block">
        <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-3.png" alt="" style={{ width: "80px", height: "30px" }} />
      </div>

      <div className="it-hero-2-shape-6 d-none d-xl-block">
        <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-2.png" alt="" style={{ width: "50px", height: "50px" }} />
      </div>

      <div className="it-hero-2-shape-7 d-xl-block">
        <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-1.png" alt="" />
      </div>

      <div className="it-hero-2-funfact text-center d-none d-xl-block">
        <span className="theme">
          <i className="purecounter" data-purecounter-duration="0" data-purecounter-end="30">30</i>k+
        </span>
        <span>Total Student</span>
        <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-8.png" alt="" />
      </div>
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="it-hero-2-content">
              ...
              <div className="it-hero-2-text">
                <p>
                  Lorem ipsum dolor sit amet, consectetur  elit, sed do  eiusmod  <br /> tempor  incididunt ut labore et dolore magna aliqua.
                </p>
                ...
                <div className="it-hero-2-btn-box d-flex align-items-center">
                  ...
                  <div className="it-hero-2-play">
                    <a className="popup-video" href="https://www.youtube.com/watch?v=PO_fBTkoznc" aria-label="Play video">
          ...
          <div className="col-xl-4 col-lg-4 " >
            <div className="it-hero-2-thumb-box p-relative">
              <div className="it-hero-2-thumb p-relative">
                <img src="https://ordainit.com/html/educate/assets/img/hero/hero-2.png" className="BigHero" alt="" style={{ width: "450px", height: "600px", top: "40px", right: "0" }} />

                <div className="it-hero-2-shape-1 d-none d-xl-block">
                  <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-6.png" alt="" />
                </div>

                <div className="it-hero-2-shape-2 d-none d-xl-block">
                  <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-4.png" alt="" style={{ width: "80px", height: "60px" }} />
                </div>

                <div className="it-hero-2-shape-3 d-none d-xl-block">
                  <img src="https://ordainit.com/html/educate/assets/img/hero/shape-2-5.png" alt="" style={{ width: "80px", height: "50px" }} />
                </div>
              </div>
            </div>
          </div>
